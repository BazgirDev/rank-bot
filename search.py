...
RANK_DATA = {
    "tajrobi": [
        ...
        {"min": 6000, "max": 6500, "ranks": {"1": "۳۵۰۰۰-۴۰۰۰۰", "2": "۳۵۰۰۰-۴۲۰۰۰", "3": "۳۲۰۰۰-۳۴۰۰۰"}},
        {"min": 6500, "max": 7000, "ranks": {"1": "۳۰۰۰۰-۳۵۰۰۰", "2": "۳۲۰۰۰-۳۸۰۰۰", "3": "۲۸۰۰۰-۳۲۰۰۰"}},
    ...
    "riazi": [
        {"min": 0, "max": 5000, "ranks": {"1": "بالاتر از ۲۳۰۰۰", "2": "بالاتر از ۲۳۰۰۰", "3": "۵۰۰۰-۵۵۰۰"}},
        {"min": 5000, "max": 5500, "ranks": {"1": "بالاتر از ۲۰۰۰۰", "2": "بالاتر از ۲۰۰۰۰", "3": "۴۳۰۰-۵۰۰۰"}},
        {"min": 5500, "max": 6000, "ranks": {"1": "۱۵۰۰۰-۲۰۰۰۰", "2": "۱۵۰۰۰-۲۰۰۰۰", "3": "۴۰۰۰-۴۵۰۰"}},
        {"min": 6000, "max": 6500, "ranks": {"1": "۱۴۰۰۰-۱۱۵۰۰", "2": "۱۳۵۰۰-۱۶۰۰۰", "3": "۳۳۰۰-۴۰۰۰"}},
        {"min": 6500, "max": 7000, "ranks": {"1": "۹۰۰۰-۱۲۰۰۰", "2": "تا ۳۸۰۰۰", "3": "۲۸۰۰۰-۳۲۰۰۰"}},
...
GPA_TARAZ_DATA = [
    ...
    (17.40, 7539, 7710), (17.60, 7514, 7850), (17.80, 7750, 8120),
...
# برای معدل‌های کمتر از ۱۵، فایل مرجع بازه داده است (نه نقطهٔ منفرد).
GPA_TARAZ_BANDS = [
    (10.0, 11.0, 4321, 4782),
    (11.0, 12.0, 4782, 5198),
    (12.0, 12.5, 5198, 5431),
...
# جدول مرجع ارسالی کاربر برای تبدیل میانگین درصد به تراز کنکور ۱۴۰۴.
PERCENT_TARAZ_DATA_1404 = {
    "tajrobi": [
        (0, 3712), (5, 5721), (10, 6411), (15, 7210), (20, 7513),
        (25, 7983), (30, 8380), (35, 8740), (40, 9021), (45, 9397),
        (50, 10500), (55, 10411), (60, 10859), (65, 11192), (70, 11438),
